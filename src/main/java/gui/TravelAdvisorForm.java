...
//        sets up center BorderLayout
        ...
        container.CancelTicketPanel cancelTicketPanel = new container.CancelTicketPanel();
        cancelTicketPanel.setLayout(new BoxLayout(cancelTicketPanel,BoxLayout.Y_AXIS));
        cancelTicketPanel.setVisible(false);

        container.GenerateReportPanel generateReportPanel = new container.GenerateReportPanel();
        ...
        container.ManageCustomerPanel manageCustomerPanel = new container.ManageCustomerPanel();
        manageCustomerPanel.setLayout(new BoxLayout(manageCustomerPanel,BoxLayout.Y_AXIS));
        manageCustomerPanel.setVisible(false);

        container.ManageDiscountsPanel manageDiscountsPanel = new container.ManageDiscountsPanel();
        manageDiscountsPanel.setLayout(new BoxLayout(manageDiscountsPanel,BoxLayout.Y_AXIS));
        manageDiscountsPanel.setVisible(false);

        container.UpdateCustomerPanel updateCustomerPanel = new container.UpdateCustomerPanel();
